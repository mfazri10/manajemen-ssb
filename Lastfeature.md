...
- [x] Buat halaman "Daftarkan Akademi Baru" (Frontend)
- [x] Testing: buat 2 tenant, pastikan data terisolasi
...
- [x] **Update Apollo Client — Kirim `x-tenant-slug` Header (Frontend)**
...
- [x] **Buat Tenant Switcher untuk Superadmin (Frontend)**
...
- [x] **Buat Service `migrateAllTenants` di Drizzle (Backend)**
  * **Cara kerja:**
...
* [x] **Frontend Apollo Client Integration:** Mengatur Apollo Client di Next.js & Mobile agar otomatis mengirimkan header `x-tenant-slug`.
* [x] **Tenant Switcher:** Halaman khusus bagi Superadmin untuk berpindah konteks antar tenant akademi secara dinamis.
* [x] **Migration Runner:** Membuat skrip otomatis untuk menjalankan migrasi DDL Drizzle ke seluruh skema `tenant_*` yang aktif.
