...
function RegisterAcademyForm() {
  ...
  const productType = searchParams.get('type') || 'akademi';
  ...
  const getProductLabel = () => {
    switch (productType) {
      case 'gor':
        return 'GOR / Tempat Sewa Lapangan';
      case 'gym':
        return 'Gym, Fitness / Studio Kebugaran';
      default:
        return 'Akademi / Sekolah Olahraga';
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!slug) {
      setErrorMsg('Slug URL tidak boleh kosong.');
      return;
    }
    ...
    try {
      ...
      setErrorMsg(err?.message || 'Gagal mendaftarkan bisnis olahraga Anda. Silakan coba lagi.');
    }
  };
      ...
      <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 md:p-10 shadow-2xl relative">
        ...
        <div className="text-center mb-8 mt-2">
          ...
          <h1 className="text-2xl font-black tracking-tight text-white mt-3 flex items-center justify-center gap-1.5">
            Daftarkan {getProductLabel()} <Sparkles className="w-5 h-5 text-yellow-400" />
          </h1>
          <p className="text-xs text-slate-400 mt-1 max-w-sm mx-auto font-medium">
            Satu langkah lagi untuk mulai mengelola {getProductLabel().toLowerCase()} Anda secara digital dan profesional.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Contoh: GOR Futsal Sentosa"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="gor-futsal-sentosa"
          ...
          >
            {loading ? (
              ...
              <span>Daftarkan Sekarang (Free Trial 7 Hari)</span>
            )}
          </button>
        </form>
      </div>
